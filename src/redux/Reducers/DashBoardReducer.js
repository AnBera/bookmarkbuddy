...
export const DashBoardReducer = (state = INITIAL_STATE, action) => {
  switch (action.type) {
    case types.SET_MOST_VISITED_SITES:
      return {
        ...state, mostVisitedSites: action.sites
      };
    ...
    case types.SET_RECENT_BOOKMARKS:
      return {
        ...state, recentBookmarks: action.Bookmarks
      };

    case types.SET_FILTERED_BOOKMARKS:
      return {
        ...state, FilteredBookmarks: action.Bookmarks
      };

    case types.SET_BOOKMARK_FOLDERS:
      return {
        ...state, bookmarkFolders: action.Folders
      };

    case types.SET_SEARCHED_TERM:
      return {
        ...state, searchTerm: action.SearchedText
      };

    case types.SET_SELECTED_FOLDER:
      return {
        ...state, selectedFolder: action.FolderName
      };
    ...
    case types.SET_COLORS_MAP:
      return {
        ...state, colorsMap: action.colorsMap
      };
    case types.GOT_IMAGES_SUCCESSFULLY:
      return {
        ...state, isImagesConverted: true
      };
